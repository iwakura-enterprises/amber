...
|--------------|-------------------|-----------------------------------------------------------------------|
| Amber Core   | The Java library  | <a id="amber_core_version" href="https://central.sonatype.com/artifact/enterprises.iwakura/amber"><img src="https://maven-badges.sml.io/sonatype-central/enterprises.iwakura/amber-core/badge.png?style=for-the-badge" alt=""></img></a>   |
| Amber Plugin | The Gradle plugin | <a id="amber_plugin_version" href="https://plugins.gradle.org/plugin/enterprises.iwakura.amber"><img src="https://img.shields.io/gradle-plugin-portal/v/enterprises.iwakura.amber?style=for-the-badge" alt=""></img></a> |
